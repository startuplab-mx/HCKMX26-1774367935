...
object PopUp {
    ...
    var notificationTitle: String = "Overlay Active"
    ...
    fun savePreferences(context: Context) {
        ...
        sharedPref.edit().putBoolean("swipeToDismiss", swipeToDismiss).apply()
        ...
        sharedPref.edit().putString("notificationIcon", notificationIcon).apply()
        sharedPref.edit().putString("notificationTitle", notificationTitle).apply()
        sharedPref.edit().putString("notificationText", notificationText).apply()
    }
    ...
    fun loadPreferences(context: Context) {
        ...
        swipeToDismiss = sharedPref.getBoolean("swipeToDismiss", swipeToDismiss)
        ...
        notificationIcon = sharedPref.getString("notificationIcon", notificationIcon) ?: ""
        notificationTitle = sharedPref.getString("notificationTitle", notificationTitle) ?: "Overlay Active"
        notificationText = sharedPref.getString("notificationText", notificationText) ?: ""
    }
}
